        ...
        const processDecks = (currentCards: Card[], currentDecks: Deck[]) => {
          ...
          return currentDecks.map(deck => {
            ...
            cardsInDeck.forEach(card => {
              if (card.nextReview * 1000 < currentTime) { // Multiplicar por 1000 aquí también
                cardsForStudy++;
              } else {
                cardsReviewed++;
                if (card.nextReview * 1000 < minNextReviewTime) { // Multiplicar por 1000 aquí también
    ...
    <div className="relative flex size-full min-h-screen flex-col bg-white justify-between group/design-root overflow-x-hidden" style={{ fontFamily: 'Manrope, "Noto Sans", sans-serif' }}>
      ...
      <div>
        <div className="flex gap-2 border-t border-[#f0f2f4] bg-white px-4 pb-3 pt-2">
          ...
          <Link className="just flex flex-1 flex-col items-center justify-end gap-1 rounded-full text-[#111418]" to="/decks">
          ...
          <Link className="just flex flex-1 flex-col items-center justify-end gap-1 text-[#637488]" to="/study">
          ...
          <Link className="just flex flex-1 flex-col items-center justify-end gap-1 text-[#637488]" to="/profile">
