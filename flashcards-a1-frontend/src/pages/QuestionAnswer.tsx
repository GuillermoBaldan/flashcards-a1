...
const QuestionAnswer: React.FC = () => {
  ...
  const DeckTile: React.FC<{ deck: Deck }> = ({ deck }) => (
    <Link to={`/decks/${deck._id}/cards`} className="flex flex-col items-start gap-2 bg-white rounded-xl p-4 shadow-sm h-36 w-full">
      <div className="flex items-center justify-center rounded-lg bg-[#f0f2f4] shrink-0 size-10" style={{ backgroundColor: deck.color || '#f0f2f4' }}>
